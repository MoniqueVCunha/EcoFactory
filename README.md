Calma, sem estresse! O segredo no VS Code é colar EXATAMENTE o texto abaixo dentro do seu ficheiro README.md (sem colocar nada antes ou depois):
...
Bash
git clone https://github.com/MoniqueVCunha/EcoFactory.git
cd EcoFactory
...
Dashboard: GET em /dashboard (indicadores consolidados)
